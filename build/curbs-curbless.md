...
description:
  'How showers contain water at the entry, including curbed and curbless designs
...
This page explains **why shower curbs exist**, how curbless showers are
permitted in New Jersey, and what inspectors are evaluating when reviewing
thresholds and transitions.

This guide follows
[**TCNA Handbook**](https://www.tcnatile.com/products/handbook.html) threshold
design methods for curbless configurations and curb detailing.
...
> **The shower entry must prevent water from leaving the wet area under normal
> use and during temporary drain restriction.**

Whether achieved with a curb or a curbless design, the goal is the same:
...
When a shower includes a curb, model plumbing codes adopted by New Jersey
typically expect:
...
This is **not** measured from the bathroom floor. It applies only when a curb is
present.
...
Curbless showers are **not prohibited** in New Jersey residential construction,
but they are treated as **performance-based designs**.
...
> Removing the curb increases planning responsibility—it does not remove
> requirements.
...
**Early coordination is strongly recommended.** Before finalizing a curbless
design:
...
> **Pro tip:** Not all inspectors have extensive experience with curbless
> showers. Providing clear documentation of your design intent—including TCNA
> method references—can facilitate approval.
...
Standard residential remodels are **not automatically subject** to accessibility
requirements, even when curbless designs are chosen.

However, if you're planning for aging-in-place or future accessibility needs,
consider:
...
**Framing for Benches, Seats & Niches** How structural planning supports
long-term performance and inspection approval.
