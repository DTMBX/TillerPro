...
description:
  'How showers manage water before tile—proper slope, pan construction, and
  drainage according to TCNA standards.'
...
This page explains **how showers actually manage water**, why slope and drain
selection matter more than tile, and what New Jersey inspectors are looking for
_before_ waterproofing and finishes.

This guide follows
[**TCNA Handbook**](https://www.tcnatile.com/products/handbook.html) guidance on
pan design, pre-slope systems, and drainage—the foundation that prevents
failure.
...
Tile and grout are finishes—not water control systems. Code compliance and
long-term performance depend on what happens beneath them.
...
([IPC Section 417.5.2](https://codes.iccsafe.org/)):
...
The slope must exist in the **waterproofing layer**, not just in the tile
surface.

| What Homeowners Often Think        | What's Actually Required                    |
| ---------------------------------- | ------------------------------------------- |
| "The tile is sloped"               | The slope must be _under_ the waterproofing |
| "Water finds its way to the drain" | Water must be _directed_ by slope, not luck |
...
> **Homeowner insight:** If your contractor says they'll "slope it with
> thinset," that's a warning sign. Proper slope is built into the mortar bed or
> pre-sloped pan—not the tile layer.

---

## Drain Type Determines the System

Before a pan is built, the drain type must be selected. **Mixing drain types and
waterproofing methods is a common cause of failure.**
...
- System must meet
  [ANSI A118.10](https://www.tcnatile.com/tcna-committees/ansi-standards.html)
...
> **Why this matters:** Traditional clamping drains require _two_ slopes—one
> under the liner (pre-slope) and one above it (for the tile). Many contractors
> skip the pre-slope, causing failures years later.
...
**This method is still valid but requires more steps and is prone to execution
errors.**
...
> **Homeowner note:** Pre-formed systems are excellent choices when properly
> installed—but they require strict adherence to manufacturer instructions and
...
The drain should finish **flush with or slightly below** the tile surface—never
recessed or crowned.
...
| Pre-slope (if traditional) | Slope exists _under_ the liner            |

Some municipalities require a dedicated pan or waterproofing inspection before
tile. Ask your contractor to confirm this with your local AHJ.
...
**Waterproofing Systems (Surface vs. Traditional)** How water is contained and
directed once slope and drainage are established.
