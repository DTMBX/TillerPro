(!(function () {
  ...
  if (e) {
    ...
    function i() {
      ...
      (i > 50 ? e.classList.add('ts-header--scrolled') : e.classList.remove('ts-header--scrolled'),
        (t = i),
        (s = !1));
    }
  ...
  (!(function () {
    const e = document.querySelectorAll('.has-dropdown');
    (e.forEach((t) => {
      const s = t.querySelector('.desktop-nav__trigger'),
        i = t.querySelector('.desktop-nav__dropdown');
      s &&
        i &&
        (s.addEventListener('click', (i) => {
          ...
          (e.forEach((e) => {
            if (e !== t) {
              ...
              const t = e.querySelector('.desktop-nav__trigger');
              t && t.setAttribute('aria-expanded', 'false');
            }
          }),
            n
              ? (t.classList.remove('is-open'), s.setAttribute('aria-expanded', 'false'))
              : (t.classList.add('is-open'), s.setAttribute('aria-expanded', 'true')));
        }),
    ...
    const t = document.querySelector('.mobile-nav__toggle'),
      s = document.getElementById('mobile-nav'),
      i = document.querySelector('.mobile-nav__close'),
      n = () => window.innerWidth < 1080;
    t &&
      s &&
      t.addEventListener('click', () => {
        const e = 'true' === t.getAttribute('aria-expanded');
        (t.setAttribute('aria-expanded', e ? 'false' : 'true'),
          s.setAttribute('aria-hidden', e ? 'true' : 'false'),
          n());
      });
    i &&
      s &&
    ...
    document.querySelectorAll('.mobile-nav__accordion-trigger').forEach((e) => {
      e.addEventListener('click', function () {
        const e = 'true' === this.getAttribute('aria-expanded'),
          t = this.nextElementSibling;
        (this.setAttribute('aria-expanded', e ? 'false' : 'true'), t && (t.hidden = e));
      });
    });
  })(),
    (function () {
      ...
      document.querySelectorAll('.animate-on-scroll').forEach((t) => e.observe(t));
    })());
})(),
  (function () {
    'use strict';
    const e = {
      ...
      initFormEnhancements() {
        (document.querySelectorAll('form[action]').forEach((e) => {
          e.addEventListener('submit', (t) => {
            ...
            const s = e.querySelector('[type="submit"]');
            (s &&
              (s.classList.add('btn--loading'),
              s.setAttribute('aria-busy', 'true'),
              (s.disabled = !0)),
              e.hasAttribute('data-netlify') && sessionStorage.setItem('form-submitted', 'true'));
          });
      ...
      validateField(e) {
        ...
        if (t)
          ...
          ((s.className = 'error-message'),
            (s.textContent = e.validationMessage || 'This field is required'),
            (s.id = `${e.id || e.name}-error`),
      ...
      showFormErrors(e) {
        ...
        let s = e.querySelector('.error-summary');
        (s ||
          ...
          (s.innerHTML = `\n        <strong class="error-summary__title">Please fix the following errors:</strong>\n        <ul class="error-list">\n          ${Array.from(
            ...
            .map((t) => {
              const s = e.querySelector(`label[for="${t.id}"]`),
                i = s ? s.textContent : t.name;
              return `<li><a href="#${t.id}">${i}: ${t.validationMessage}</a></li>`;
            })
            .join('')}\n        </ul>\n      `),
      ...
      showSuccessToast(e, t = 5e3) {
        ...
        ((i.className = 'toast--success'), i.setAttribute('role', 'status'), (i.textContent = e));
      ...
      showErrorToast(e, t = 7e3) {
        const s = document.getElementById('toast-container'),
          i = document.createElement('div');
        return (
          (i.className = 'toast--success'),
          i.setAttribute('role', 'alert'),
          (i.style.cssText =
            '\n        background: #FEF2F2;\n        border-color: #DC2626;\n        color: #991B1B;\n      '),
          (i.textContent = e),
          s.appendChild(i),
          t > 0 && setTimeout(() => i.remove(), t),
          i
        );
      },
      initErrorVisibility() {
  ...
  (function () {
    ...
    function s() {
      t() && window.ScrollLockManager && window.ScrollLockManager.lock('scroll-fix');
    }
    function i() {
      window.ScrollLockManager && window.ScrollLockManager.unlock('scroll-fix');
    }
    let n;
    (new MutationObserver((t) => {
      t.forEach((t) => {
        if ('attributes' === t.type && 'class' === t.attributeName) {
          const t = document.body.classList.contains('nav-open');
          t !== e && ((e = t), e ? s() : i());
        }
      });
      ...
      window.addEventListener(
        ...
        () => {
          (clearTimeout(n),
            (n = setTimeout(() => {
              if (!t() && e) {
                (document.body.classList.remove('nav-open'), i());
                const e = document.getElementById('mobile-nav-drawer');
      ...
      (window.tsScrollFix = { enable: i, disable: s, isEnabled: () => !e || !t() }));
  })());
