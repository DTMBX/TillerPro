...
\- FM-01 Cracked grout (random / linear)

\- FM-02 Hollow / loose tile

\- FM-03 Tenting / debonded “popped” tile

\- FM-04 Lippage / poor plane control

\- FM-05 Water intrusion (showers, tub surrounds, floors)

\- FM-06 Efflorescence / mineral staining

\- FM-07 Soft / powdery grout

\- FM-08 Curling / warpage telegraphing / layout distortion

\- FM-09 Staining / blotchy stone or grout discoloration

\- FM-10 Mold odor / chronic dampness behind tile

\- FM-11 Transition cracking (tile-to-wood, tile-to-vinyl, tile-to-concrete)
...
\- Hairline cracks following traffic paths or spanning multiple joints

\- Wider cracks along joist lines or transitions
...
\- Tap test tile near crack: hollow sound = likely bond/coverage or movement

\- Check perimeter: is tile hard-tight to walls/base? (no movement gap)

\- Check transitions: doorway thresholds, cabinetry kicks, islands
...
\- Tile sounds hollow; sometimes “click” under foot

\- Grout cracks around one tile
...
\- Skinned mortar (open time exceeded)

\- Dust/contamination on substrate or tile backs
...
\- Look for ridges not collapsed / no key-in coat
...
\- A ridge or “bubble” line; tiles lifted like a hinge

\- Sudden failure sometimes after heat/sun or seasonal change
...
\- Tile bonded over active joints without honoring them
...
\- Check perimeter under base/shoe: is there a gap or is tile jammed?

\- Check if grout is hard at changes of plane (no sealant joint)
...
\- Edges catch socks; shadow lines across floor

\- Worse on large-format tile; worse in raking light
...
\- Warped tile + poor layout/offset decisions
...
\- Make flatness a precondition (prep before you set)

\- Control layout decisions (offsets, running bond choices)
...
\- Dark grout that never dries

\- Swollen baseboards outside shower

\- Staining at ceiling below; loose bottom-row tiles
...
\- Incorrect drain integration / slope issues
...
\- Waterproofing continuity is treated as a system, not a product
...
\- White crystalline haze on grout/tile
...
\- Excess water in grout, cure conditions, or ongoing moisture source
...
\- Solve moisture source first; do not “clean” your way out
...
\- Grout scratches out with a key
...
\- Check joint depth and hardness in multiple areas
...
\- Crack line at doorway or material change
...
\- Substrate joint not honored; hard grout where sealant should be
...
\- Edge detail (perimeter / transition)
...
\- “This is what movement looks like when it has nowhere to go.”

\- “This hollow sound isn’t cosmetic. It’s bond loss telling on itself.”
