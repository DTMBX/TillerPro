...
This document outlines the comprehensive fixes and improvements made to resolve
scroll blocking, restore performance features, and ensure proper scaling.
...
- CSS rule `body.nav-open { overflow: hidden !important; }` was applying
  globally
- JavaScript was setting `document.body.style.overflow = 'hidden'` without
  proper cleanup
...
**Solution:** Created `/assets/js/performance-mode.js` with comprehensive
features:
...
- 📝 **MODIFIED:** `/_includes/layout/head.html` - Updated viewport meta, added
  scaling CSS
...
**Last Updated:** January 26, 2026 **Version:** 2.0.0 **Author:** Copilot
Workspace Agent
