...
const DEMO_USERS = {
  'sarah-johnson': {
    ...
    benefitLedger: {
      ...
      monthsAccrued: 12,
      transactions: [
        { date: '2026-01-20', amount: 127.5, score: 92, tier: 'Excellent' },
        { date: '2025-12-20', amount: 118.25, score: 89, tier: 'Good' },
        { date: '2025-11-20', amount: 124.1, score: 91, tier: 'Excellent' },
        { date: '2025-10-20', amount: 115.8, score: 88, tier: 'Good' },
        { date: '2025-09-20', amount: 121.4, score: 90, tier: 'Excellent' },
      ],
    },
    claims: [],
    claimFreeDays: 437,
  ...
  'michael-chen': {
    ...
    benefitLedger: {
      ...
      monthsAccrued: 3,
      transactions: [
        { date: '2026-01-20', amount: 107.2, score: 78, tier: 'Fair' },
        { date: '2025-12-20', amount: 99.2, score: 74, tier: 'Fair' },
        { date: '2025-11-20', amount: 81.2, score: 72, tier: 'Fair' },
      ],
    },
    claims: [
      {
        ...
        timeline: [
          {
            date: '2025-12-18',
            event: 'Claim Filed',
            note: 'Initial report submitted with photos',
          },
          { date: '2025-12-19', event: 'Under Review', note: 'Assigned to claims adjuster' },
          {
            date: '2025-12-21',
            event: 'Approved',
            note: 'Not at fault verified via police report',
          },
  ...
  'emma-rodriguez': {
    ...
    benefitLedger: {
      ...
      monthsAccrued: 6,
      transactions: [
        { date: '2026-01-20', amount: 145.8, score: 97, tier: 'Excellent' },
        { date: '2025-12-20', amount: 147.6, score: 98, tier: 'Excellent' },
        { date: '2025-11-20', amount: 141.6, score: 96, tier: 'Excellent' },
        { date: '2025-10-20', amount: 145.8, score: 97, tier: 'Excellent' },
        { date: '2025-09-20', amount: 145.8, score: 97, tier: 'Excellent' },
        { date: '2025-08-20', amount: 115.9, score: 95, tier: 'Excellent' },
      ],
    },
    claims: [],
    claimFreeDays: 196,
  ...
  'james-williams': {
    ...
    benefitLedger: {
      ...
      monthsAccrued: 8,
      transactions: [
        { date: '2026-01-20', amount: 53.4, score: 64, tier: 'Needs Improvement' },
        { date: '2025-12-20', amount: 57.12, score: 68, tier: 'Fair' },
        { date: '2025-11-20', score: 71, tier: 'Fair', amount: 60.24 },
        { date: '2025-10-20', amount: 58.8, score: 70, tier: 'Fair' },
    ...
    claims: [
        ...
        timeline: [
          {
            date: '2025-08-15',
            event: 'Claim Filed',
            note: 'Police report #2025-08-NJ-4521 attached',
          },
          { date: '2025-08-16', event: 'Under Review', note: 'Claims investigator assigned' },
          {
            date: '2025-08-20',
            event: 'Additional Info Requested',
            note: 'Tool purchase receipts needed',
          },
          {
            date: '2025-08-22',
            event: 'Documentation Received',
            note: 'Member submitted receipts',
          },
          {
            date: '2025-08-25',
            event: 'Approved',
            note: 'Verified via receipts and police report',
          },
      ...
      },
      {
        ...
        timeline: [
          ...
          {
            date: '2026-01-15',
            event: 'Third Party Contacted',
            note: 'Obtaining repair estimate from other party',
          },
        ],
      },
    ],
