...
Added comprehensive development dependencies (40+ packages) and 5 new utility
scripts to improve build pipeline, SEO, image optimization, and code quality.
...
- Deprecated packages: inflight, rimraf, glob@7, whatwg-encoding, uuid@3,
  puppeteer@2
