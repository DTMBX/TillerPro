# Manufacturer Specifications Mastersheet

## Tillerstead.com - Technical Data Reference

**Last Updated:** 2026-01-19  
**Purpose:** Consolidated TDS-sourced specifications for tile installation
calculators  
...
#### Custom Building Products - VersaBond LFT (Large Format Tile)
...
**Coverage by Trowel Size (verified Jan 2026):** | Trowel | Min Coverage | Max
Coverage | Notes | |--------|--------------|--------------|-------| | 1/4"×1/4"
Square | 90 sq ft | 100 sq ft | For tile up to 8"×8" | | 1/4"×3/8" Square | 60
sq ft | 67 sq ft | For tile 8"×8" to 13"×13" | | 1/2"×1/2" Square | 42 sq ft |
47 sq ft | ⚠️ **NOT RECOMMENDED** for LFT | | **3/4"×9/16" U-notch @ 45°** | 34
sq ft | 38 sq ft | ✅ **RECOMMENDED** for LFT ≥15" | | **3/4"×9/16" U-notch @
30°** | 42 sq ft | 47 sq ft | ✅ **RECOMMENDED** - same yield as 1/2" sq, better
coverage |

> ⚠️ **CRITICAL WARNING (from CBP TDS):** Custom Building Products does NOT
> recommend the use of a 1/2"×1/2"×1/2" Square-Notched trowel for Large Format
> Tile. The 1/2" spacing between each square notch has been shown to make it
> more difficult to bed tiles and achieve proper mortar coverage. CUSTOM
> recommends the use of a trowel design that promotes mortar ridge collapse such
> as either a deeper, slanted, U-notch, V-notch, or ridged large format trowel
> when applying thicker amounts of mortar.
...
#### Custom Building Products - VersaBond (Standard)

| Specification | Value                | Source |
| ------------- | -------------------- | ------ |
| Package Size  | 50 lb bag            | TDS    |
| Type          | Modified thin-set    | TDS    |
| Standards     | ANSI A118.4, A118.11 | TDS    |

**Coverage by Trowel Size:** | Trowel | Min Coverage | Max Coverage | Notes |
|--------|--------------|--------------|-------| | 1/4"×1/4" Square | 90 sq ft |
100 sq ft | Standard wall tile | | 1/4"×3/8" Square | 60 sq ft | 67 sq ft |
Medium format floor | | 1/2"×1/2" Square | 42 sq ft | 47 sq ft | Large format
tile |

**Source:**
https://www.custombuildingproducts.com/products/versabond-professional-thin-set-mortar-2
...
| ------------- | ------------------ | ------ |
| Package Size  | 50 lb bag          | TDS    |
| Type          | Unmodified dry-set | TDS    |
| Standards     | ANSI A118.1        | TDS    |

**Coverage by Trowel Size:** | Trowel | Min Coverage | Max Coverage |
|--------|--------------|--------------| | 1/4"×1/4" Square | 75 sq ft | 100 sq
ft | | 1/2"×1/2" Square | 40 sq ft | 50 sq ft |

**Note:** Required for Schluter KERDI membrane installation.

**Source:**
https://www.mapei.com/us/en-us/products-and-solutions/products/detail/kerabond-t
...
**Coverage Chart (verified Jan 2026 from CBP website):** | Application |
Coverage per Gallon | 3.5 Gal Coverage |
|-------------|--------------------|--------------------| | Crack Prevention
Membrane | 100 sq ft | 350 sq ft | | Crack Prevention (ANSI A118.12) | 25 sq ft
| 88 sq ft | | **Waterproof Membrane** | **55 sq ft** | **192 sq ft** | | IAPMO
Pan Liner (ANSI A118.10) | 40 sq ft | 140 sq ft |
...
**Source:**
https://www.mapei.com/us/en-us/products-and-solutions/products/detail/mapelastic-aquadefense
...
| Coverage (2 coats) | 50 sq ft/gal          | TDS    |
| Cured Thickness    | 20-30 mils            | TDS    |
| Standards          | ANSI A118.10, A118.12 | TDS    |

**Application Notes:**

- Self-curing formula
- Compatible with Hydro Ban Board

**Source:**
https://cdn-global.laticrete.com/-/media/project/laticrete-international/north-america/product-documents/product-data-sheets/lds6630_hydro-ban.ashx
...
**Roll Sizes (verified Jan 2026):** | Coverage | Dimensions |
|----------|------------| | 54.5 sq ft | 3'3" × 16'5" | | 108 sq ft | 3'3" × 33'
| | 215 sq ft | 3'3" × 65'7" | | 323 sq ft | 3'3" × 98'5" | | 646 sq ft | 6'7" ×
98'5" |
...
**Source:**
https://www.schluter.com/schluter-us/en_US/Membranes/Waterproofing-(KERDI)/Schluter%C2%AE-KERDI/p/KERDI
...
| --------------- | ---------- | ------ |
| Package Size    | 50 lb bag  | TDS    |
| Volume per Bag  | 0.5 cu ft  | TDS    |
| Coverage @ 1/8" | 48 sq ft   | TDS    |
| Min Thickness   | 1/8"       | TDS    |
| Max Thickness   | 1"         | TDS    |
| Standards       | ASTM C1708 | TDS    |

**Application Notes:**

- Requires Primer T or ECO Prim Grip
- Can extend with aggregate for deeper pours

**Source:**
https://www.mapei.com/us/en-us/products-and-solutions/products/detail/self-leveler-plus
...
| --------------- | ----------------- | ------ |
| Package Size    | 50 lb bag         | TDS    |
| Volume per Bag  | 0.4 cu ft         | TDS    |
| Coverage @ 1/8" | 44 sq ft          | TDS    |
| Min Thickness   | 1/16" (feathered) | TDS    |
| Max Thickness   | 2"                | TDS    |
| Standards       | ASTM C1708        | TDS    |

**Application Notes:**

- Premium rapid-drying formula
- Primer required
- Can feather to 1/16" at edges

**Source:** https://www.ardexamericas.com/product/ardex-k-15/

---

### GROUTS

#### Custom Building Products - Polyblend Sanded

| Specification | Value       | Source |
| ------------- | ----------- | ------ |
| Package Size  | 25 lb bag   | TDS    |
| Type          | Sanded      | TDS    |
| Joint Width   | ≥ 1/8"      | TDS    |
| Standards     | ANSI A118.6 | TDS    |

**Coverage Note:** Varies by tile size, joint width, and thickness. Use
geometric formula.

**Source:**
https://www.custombuildingproducts.com/products/polyblend-sanded-grout

---

#### Custom Building Products - Polyblend Non-Sanded

| Specification | Value       | Source |
| ------------- | ----------- | ------ |
| Package Size  | 10 lb bag   | TDS    |
| Type          | Non-sanded  | TDS    |
| Joint Width   | < 1/8"      | TDS    |
| Standards     | ANSI A118.6 | TDS    |
...
- Recommended for polished marble/soft stone

**Source:**
https://www.custombuildingproducts.com/products/polyblend-non-sanded-grout
...
> ⚠️ **CRITICAL:** If substrate does not meet flatness tolerances, lippage
> standards do NOT apply. Installer cannot be held responsible for lippage
> caused by out-of-tolerance substrate.
...
_L = span length in inches. Example: 10 ft (120") span ÷ 360 = 0.33" max
deflection_
...
> ⚠️ **CRITICAL:** All substrate movement/control joints MUST be honored through
> the tile installation. Movement joints filled with sealant (ASTM C920), NOT
> grout.
...
2. **Ridge Collapse:** Press tile perpendicular to ridges to collapse and
   eliminate voids
3. **Verify Coverage:** Periodically lift tiles to confirm coverage (especially
   first few tiles)
...
1. **Trowel Selection:** Use U-notch or ridged trowel—NOT 1/2" square (per CBP
   TDS)
2. **Back-Butter:** Required on every tile for 95% coverage
3. **Offset Limit:** Maximum 33% offset for running bond (not 50%)—reduces
   lippage
4. **Leveling System:** Use clips and wedges for consistent lippage control
5. **Substrate Prep:** MUST meet LFT flatness tolerance (1/8" in 10 ft) before
   starting

### Waterproofing

1. **Coat Direction:** Apply coats in perpendicular directions (cross-hatch
   pattern)
2. **Thickness Verification:** Use mil gauge to verify wet film thickness
3. **Corner Treatment:** Embed fabric/mesh tape in FIRST coat at all corners and
   seams
4. **Penetrations:** Seal around ALL penetrations—valves, pipes, drains
5. **Flood Test:** Test before tiling—plug drain, fill 1-2" above threshold,
   hold 24-48 hours
6. **KERDI Specific:** MUST use unmodified thinset (ANSI A118.1)—modified will
   NOT bond
...
5. **Cleaning Window:** Clean when grout firms (fingerprint test)—not too soon,
   not too late
...
- KERDI:
  https://www.schluter.com/schluter-us/en_US/Membranes/Waterproofing-(KERDI)/Schluter%C2%AE-KERDI/p/KERDI
- KERDI-BAND:
  https://www.schluter.com/Membranes/Waterproofing-(KERDI)/Schluter%C2%AE-KERDI-BAND/p/KERDI_BAND
- Shower System Estimator:
  https://www.schluter.com/schluter-us/en_US/projects/estimator/shower-system-estimator
...
- TCNA ANSI Standards:
  https://www.tcnatile.com/tcna-committees/ansi-standards.html
...
Coverage rates shown are manufacturer-specified values from official Technical
Data Sheets (TDS). Actual coverage varies by:

- Substrate condition and flatness
- Application technique
- Environmental conditions (temperature, humidity)
- Tile back pattern and texture

**Always verify with the current product TDS before purchasing materials.**

---

_Generated from Tillerstead Technical Products Database_
