...
The Tillerstead LLC logo appeared squished across multiple instances on the
website due to incorrect `aspect-ratio` CSS property.

**Root Cause:** Logo is 480×320 pixels (3:2 aspect ratio), but CSS was set to
