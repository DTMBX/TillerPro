...
This directory contains comprehensive performance optimization tools for the
Tillerstead website. These tools help achieve **sub-2-second load times** and
...
- **Runtime caching**: Images (30 days), CSS/JS (7 days), HTML (1 day), Fonts (1
  year)
...
```javascript
const criticalPages = [{ src: 'your-page.html', dest: 'your-page.html' }];
```
